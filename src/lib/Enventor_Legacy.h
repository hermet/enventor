...
EAPI void enventor_item_syntax_color_full_apply(Enventor_Item *it, Eina_Bool force);
EAPI void enventor_item_syntax_color_partial_apply(Enventor_Item *it, double interval);
EAPI void enventor_item_select_region_set(Enventor_Item *it, int start, int end);
EAPI void enventor_item_select_none(Enventor_Item *it);
EAPI void enventor_item_cursor_pos_set(Enventor_Item *it, int position);
...
EAPI void enventor_item_text_insert(Enventor_Item *it, const char *text);
